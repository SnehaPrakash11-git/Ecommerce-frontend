...
<img src={womensproduct.image} alt=""></img>
<img src={womensproduct.image} alt=""></img>
<img src={womensproduct.image} alt=""></img>
<img src={womensproduct.image} alt=""></img>
                </div>
                <div className="productdisplay-img">
                <img className="productdisplay-main-img" src={womensproduct.image} alt=""></img>
                </div>
            </div>
            <div className="productdisplay-right">
                ...
                <div className="productdisplay-right-prices">
                    <div className="productdisplay-right-price-old">${womensproduct.old_price}</div>
                    <div className="productdisplay-right-price-new">${womensproduct.new_price}</div>
                </div>
                ...
                <button onClick={()=>{addToCart(womensproduct.id)}}>ADD TO CART</button>
